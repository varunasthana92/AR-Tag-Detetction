...
while (cap.isOpened()):	
	...
	for H in H_allTags:
		...
		cubeHomoTop= np.array([[0,0,200,1], 
							 [imgH-1,0,200,1],
							 [imgW-1, imgH-1,200,1],
							 [0,imgW-1,200,1]])

		cubeHomo= np.array([[0,0,0,1], 
							 [imgH-1,0,0,1],
							 [imgW-1, imgH-1,0,1],
							 [0,imgW-1,0,1]])
		...
		cubeImgTop=[]
		for i in range(4):
			temp= np.matmul(P, cubeHomo[i])
			temp= temp/temp[-1]
			temp1= np.matmul(P, cubeHomoTop[i])
			temp1= (temp1/temp1[-1])
			if (temp[0] < gray.shape[1] and temp[0] > 0 and temp[1] < gray.shape[0] and temp[1] > 0):
				cubeImgTop.append(temp1)
				cubeImg.append(temp)


		cv2.line(frame1,(int(cubeImg[0][0]),int(cubeImg[0][1])), (int(cubeImg[1][0]),int(cubeImg[1][1])),[0,255,0],4)
		cv2.line(frame1,(int(cubeImg[1][0]),int(cubeImg[1][1])), (int(cubeImg[2][0]),int(cubeImg[2][1])),[0,255,0],4)
		cv2.line(frame1,(int(cubeImg[2][0]),int(cubeImg[2][1])), (int(cubeImg[3][0]),int(cubeImg[3][1])),[0,255,0],4)
		cv2.line(frame1,(int(cubeImg[3][0]),int(cubeImg[3][1])), (int(cubeImg[0][0]),int(cubeImg[0][1])),[0,255,0],4)


		cv2.line(frame1,(int(cubeImgTop[0][0]),int(cubeImgTop[0][1])), (int(cubeImgTop[1][0]),int(cubeImgTop[1][1])),[0,255,0],4)
		cv2.line(frame1,(int(cubeImgTop[1][0]),int(cubeImgTop[1][1])), (int(cubeImgTop[2][0]),int(cubeImgTop[2][1])),[0,255,0],4)
		cv2.line(frame1,(int(cubeImgTop[2][0]),int(cubeImgTop[2][1])), (int(cubeImgTop[3][0]),int(cubeImgTop[3][1])),[0,255,0],4)
		cv2.line(frame1,(int(cubeImgTop[3][0]),int(cubeImgTop[3][1])), (int(cubeImgTop[0][0]),int(cubeImgTop[0][1])),[0,255,0],4)

		cv2.line(frame1,(int(cubeImg[0][0]),int(cubeImg[0][1])), (int(cubeImgTop[0][0]),int(cubeImgTop[0][1])),[0,255,0],4)
		cv2.line(frame1,(int(cubeImg[1][0]),int(cubeImg[1][1])), (int(cubeImgTop[1][0]),int(cubeImgTop[1][1])),[0,255,0],4)
		cv2.line(frame1,(int(cubeImg[2][0]),int(cubeImg[2][1])), (int(cubeImgTop[2][0]),int(cubeImgTop[2][1])),[0,255,0],4)
		cv2.line(frame1,(int(cubeImg[3][0]),int(cubeImg[3][1])), (int(cubeImgTop[3][0]),int(cubeImgTop[3][1])),[0,255,0],4)
